...
Открываем Обход (если был открыт до того как вы прочитали это, ПЕРЕЗАХОДИМ ОБЯЗАТЕЛЬНО!), ЖМЕМ ЗАКРЫТЬ РАСТ ЧТОБЫ УБИТЬ ПРОЦЕССЫ РАСТА И АНТИЧИТА, далее заходим в пуск пишем Панель Управления, заходим
